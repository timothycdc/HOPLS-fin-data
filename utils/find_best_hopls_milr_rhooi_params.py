...
def main():
    ...
    alpha_values = [1]
    lambda_P_factor_penalty_values = [0.075]
    lambda_Q_factor_penalty_values = [0.075]
    rhooi_n_iter_max_values = [100]
    rhooi_tol_values = [1e-07]
    ...
    n_jobs_val = 2 # Defaulting to 7 as seen in notebook
