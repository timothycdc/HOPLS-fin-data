...
# --- Patch TensorLy for backward compatibility ---
def old_tucker_to_tensor(core, factors, transpose_factors=False):
    return multi_mode_dot(core, factors, transpose=transpose_factors)
tl.tucker_to_tensor = old_tucker_to_tensor
